...
- Output format (Markdown):
  1) Short overall summary paragraph. For patient audience: start with a thank-you sentence and then use the phrase "Based on your answers to the questions, ..." in the paragraph. For clinician audience: use "Based on the answers to the questions, ...". The paragraph must state this is the most likely diagnosis based on the assessment and may require confirmation, and note that another related diagnosis is possible and only a proper consultation can confirm.
